...
- [ApeMind CLI 对标 gh 的能力分析与产品技术设计](engineering-process/2026-09-16-apemind-cli-gh-capability-design.md)：CLI 体验差距、服务端能力覆盖、高层命令、通用 API、MCP、Desktop 和 Skill 分工及实施优先级。
- [ApeMind CLI-first 集成设计](engineering-process/2026-09-14-apemind-cli-first-integration.md)：CLI、Desktop、DSH Agent 与 ApeMind `/api/v2` 的统一身份、凭据与进程边界；能力扩展以对标 gh 的设计为准。
