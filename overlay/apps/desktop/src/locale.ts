...
export const en = {
  ...
  startupFailed: 'ApeMind Desktop could not start',
...
export const zh = {
  application: '应用',
  startupFailed: 'ApeMind Desktop 无法启动',
  pluginsMenu: '桌面插件…',
  ...
  updateTitle: 'ApeMind Desktop 更新',
  ...
  pluginWindowTitle: 'ApeMind Desktop — 桌面插件',
